describe('Bromley cobrand', function() {
  ...
  beforeEach(function() {
    cy.intercept('**mapserver/bromley*Streetlights*', {fixture: 'bromley-lights.xml'}).as('lights');
    cy.intercept('**mapserver/bromley*PROW*', {fixture: 'bromley-prow.xml'}).as('prow');
    cy.intercept('**mapserver/bromley*Crystal_Palace*', {fixture: 'crystal_palace_park.xml'}).as('crystal');
    cy.intercept('**mapserver/bromley*National_Sports*', {fixture: 'national_sports_centre.xml'}).as('sport_centre');
    cy.intercept('**mapserver/bromley*Parks_Open_Spaces*', {fixture: 'bromley-parks.xml'}).as('parks');
