...
has upload_subdir => ( is => 'ro', default => 'tfl_licence_lights-in-trees_files' );
...
has_page applicant => (
    ...
    intro => 'lights-in-trees/applicant.html',
    next => 'contractor',
);
...
# ==========================================================================
has_page activity => (
    fields => ['lights_in_trees_activity', 'continue'],
    title => 'Purpose of the lights in trees',
    next => 'site_pedestrian_space',
);

has_field lights_in_trees_activity => (
    type => 'Text',
    widget => 'Textarea',
...
has_field site_obstruct_infrastructure => (
    type => 'Select',
    widget => 'RadioGroup',
    label => 'Will the decorations obstruct or obscure any of the following: traffic signals, signal controllers, bus stops, pedestrian crossings, junction sight lines, road lighting columns, traffic signs, parking bays, ironwork in the highway, or other street furniture?',
...
has_page uploads => (
    ...
    intro => 'lights-in-trees/uploads.html',
    next => 'payment',
