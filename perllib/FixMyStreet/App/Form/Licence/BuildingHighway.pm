...
has upload_subdir => ( is => 'ro', default => 'tfl_licence_building_over_highway_files' );
...
has_page applicant => (
    ...
    intro => 'building_over_highway/applicant.html',
    next => 'contractor',
);
...
has_page contractor => (
    ...
    title => 'Principal contractor details (Building Over Highways Principal Contractor)',
    next => 'activity',
);
...
has_page uploads => (
    ...
    update_field_list => sub {
        ...
        $form->handle_upload('upload_building_regulations', $fields);
        $form->handle_upload('upload_planning_consent', $fields);
        return $fields;
    },
    post_process => sub {
        my ($form) = @_;
        ...
        $form->process_upload('upload_building_regulations');
        $form->process_upload('upload_planning_consent');
    },
);
