...
has_field kind => (
    ...
    options => [
        { label => 'Animal noise', value => 'animal', data_hide => '#form-kind_other-row' },
        { label => 'Buskers', value => 'buskers', data_hide => '#form-kind_other-row'  },
        { label => 'Car alarm', value => 'car', data_hide => '#form-kind_other-row'  },
        { label => 'Construction site noise', value => 'construction', data_hide => '#form-kind_other-row'  },
        { label => 'Deliveries', value => 'deliveries', data_hide => '#form-kind_other-row'  },
        { label => 'DIY', value => 'diy', data_hide => '#form-kind_other-row'  },
        { label => 'House / intruder alarm', value => 'alarm', data_hide => '#form-kind_other-row' },
        { label => 'Music from pub', value => 'music-pub', data_hide => '#form-kind_other-row' },
        { label => 'Music from club/bar', value => 'music-club', data_hide => '#form-kind_other-row' },
        { label => 'Music - other', value => 'music-other', data_hide => '#form-kind_other-row' },
        { label => 'Noise from roadworks', value => 'roadworks', data_hide => '#form-kind_other-row' },
        { label => 'Noise on the road', value => 'road', data_hide => '#form-kind_other-row' },
        { label => 'Plant noise - machinery', value => 'plant-machinery', data_hide => '#form-kind_other-row' },
        { label => 'Plant noise - machinery on street', value => 'plant-street', data_hide => '#form-kind_other-row' },
