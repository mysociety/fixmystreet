package FixMyStreet::App::Form::Waste::Garden::Renew::Shared;
...
sub intro {
    return (
        ...
        fields => ['current_bins', 'bins_wanted', 'payment_method', 'payment_explanation', 'cheque_reference', 'email_renewal_reminders', 'continue_review'],
