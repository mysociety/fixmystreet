...
has_page alter => (
    ...
    update_field_list => sub {
        ...
        my $costs = WasteWorks::Costs->new({
            ...
            first_bin_discount => $c->cobrand->garden_waste_first_bin_discount_applies($form->saved_data)
        });
...
has_page summary => (
    ...
    update_field_list => sub {
        ...
        my $costs = WasteWorks::Costs->new({
            ...
            first_bin_discount => $c->cobrand->garden_waste_first_bin_discount_applies($data)
        });
