...
sub stash_body_config_json : Private {
    ...
    foreach (qw(free_mode per_item_costs base_price daily_slots items_per_collection_max food_bags_disabled show_location_page show_individual_notes band1_price band1_max)) {
