...
=item * We do not show reports made before go-live on 2026-03-16.

=cut

sub cut_off_date { '2026-03-16' }

=head2 problems_restriction/problems_sql_restriction/problems_on_map_restriction

Reports made on FMS.com before the cut off date are not shown on the Dumfries
cobrand; however if a report was fetched over Open311 it is shown regardless of
the cut off date as it's a historic defect.
