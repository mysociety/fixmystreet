...
sub state_groups_admin {
    ...
    [
        [ $rs->display('confirmed'), [ grep { $_ ne 'twin' } FixMyStreet::DB::Result::Problem->open_states ] ],
...
sub state_groups_inspect {
    ...
    my @fixed = FixMyStreet::DB::Result::Problem->fixed_states;
    [
        [ $rs->display('confirmed'), [ grep { $_ !~ /^(planned|twin)$/ } FixMyStreet::DB::Result::Problem->open_states ] ],
