...
use FixMyStreet::App::Form::Waste::Garden::Brent::Subscribe;
use FixMyStreet::App::Form::Waste::Garden::Brent::Renew;
...
sub waste_garden_subscribe_form_setup {
    ...
    my $c = $self->{c};
    if ($c->stash->{is_staff}) {
        $c->stash->{form_class} = 'FixMyStreet::App::Form::Waste::Garden::Brent::Subscribe';
    }
}
...
sub waste_garden_renew_form_setup {
    ...
    if ($c->stash->{is_staff}) {
        ...
        $c->stash->{form_class} = 'FixMyStreet::App::Form::Waste::Garden::Brent::Renew';
    }
}
