...
sub bin_services_for_address {
    ...
    if ($self->{c}->stash->{waste_features}->{bulky_missed}) {
        $self->bulky_check_missed_collection($events, {
            # Not Completed
            18491 => {
                1073 => 'Bin Collected, Excess Left',
                196 => 'Bin Empty',
                31 => 'Breakdown',
                1135 => 'CON - Builders Waste',
                1134 => 'CON - Commercial Waste',
                523 => 'Con - Food',
                609 => 'Con - Garden Waste',
                1148 => 'Con - Mixed',
                527 => 'Con - Nappies',
                529 => 'Con - Other',
                522 => 'Con - Paper & Card',
                ...
                1227 => 'CON-Hazardous',
                1146 => 'H&S - Vermin',
                905 => 'H&S Aggression / Violence',
                904 => 'H&S Damage Bin',
                903 => 'H&S Heavy Bin/Bag',
                700 => 'H&S Other',
                906 => 'H&S Unsafe Equipment',
                812 => 'H&S Unsafe Surroundings',
                913 => 'NA - Changed Key/Access Code',
                615 => 'NA - Dog Out',
                466 => 'NA - Gate Locked',
