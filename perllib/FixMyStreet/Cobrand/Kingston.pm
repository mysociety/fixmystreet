...
sub image_for_unit {
    ...
    return svg_container_bin("wheelie", '#41B28A') if $containers{+CONTAINER_RECYCLING_BIN};
    ...
    my $images = {
        ...
        2241 => svg_container_bin("wheelie", '#41B28A'), # dry mixed
        ...
        2249 => svg_container_bin("communal", '#767472', '#00A6D2'), # Communal paper
