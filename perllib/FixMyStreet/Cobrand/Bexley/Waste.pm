...
sub bin_services_for_address {
    ...
    my ($whitespace_garden, $whitespace_sacks);
    ...
    $property->{has_garden_subscription} = 1 if $property->{garden_current_subscription};
    ...
    # Or if it has one in Agile
    $property->{garden_signup_eligible} = 0 if $property->{garden_current_subscription};
    # Or if it has sacks
    $property->{garden_signup_eligible} = 0 if $whitespace_sacks;
