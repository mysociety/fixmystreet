...
region, with the ID `ami-a44a4add` and name "FixMyStreet installation
2018-06-07". You can launch an instance based on that AMI with
[this link](https://console.aws.amazon.com/ec2/home?region=eu-west-1#launchAmi=ami-a44a4add).
