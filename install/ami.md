...
region, with the ID `ami-9aae17ed` and name "Basic FixMyStreet installation
2014-12-17". You can launch an instance based on that AMI with
[this link](https://console.aws.amazon.com/ec2/home?region=eu-west-1#launchAmi=ami-9aae17ed).
