...
region, with the ID `ami-2c81095f` and name "FixMyStreet installation
2016-05-03". You can launch an instance based on that AMI with
[this link](https://console.aws.amazon.com/ec2/home?region=eu-west-1#launchAmi=ami-2c81095f).
