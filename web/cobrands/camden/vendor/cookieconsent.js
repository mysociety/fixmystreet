  ...
  cc.Popup = (function() {
    var defaultOptions = {
      ...
      content: {
        ...
        message: 'We use cookies to help make this site better.',
        dismiss: 'Got it!',
        allow: 'Accept cookies',
        deny: 'Decline',
        link: 'Find out about cookies',
        href: '/about-our-website/cookies',
        close: '&#x274c;',
        target: '_blank'
      },
      ...
      elements: {
        ...
        allow:
          '<button aria-label="allow cookies" role=button tabindex="0" class="cc-btn cc-allow" href="#">{{allow}}</button>', 
        link:
      ...
      compliance: {
        ...
        'opt-in':
          '<div class="cc-compliance cc-highlight">{{link}}{{allow}}</div>',
        'opt-out':
          '<div class="cc-compliance cc-highlight">{{link}}{{allow}}</div>'
      },
    ...
    CookiePopup.prototype.initialise = function(options) {
      ...
      if (this.options.static) {
        ...
        var wrapper;
		if(controlMenu != null){
			wrapper = appendMarkup.call(this, '<div class="cc-grower cc-grower-visible cc-grower-logged-in" id="cc-grower">' + cookiePopup + '</div>');			
		}else{
			wrapper = appendMarkup.call(this, '<div class="cc-grower cc-grower-visible" id="cc-grower">' + cookiePopup + '</div>');			
		}	
    ...
    CookiePopup.prototype.fadeOut = function() {
      ...
      if (!util.hasClass(el, 'cc-invisible')) {
        if (this.options.static) {
          var element = document.getElementById("cc-grower");	
		  //IE9 compatible way to remove the grower border	
		  element.className = element.className.replace(/\bcc-grower-visible\b/g, "");
