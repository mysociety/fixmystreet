...
FixMyStreet::override_config {
    ...
    subtest "check sendreport failure messages" => sub {
        ...
        stdout_like { $e->end_summary_failures } qr%The following 4 reports had problems sending:\nBromley Council \(1\): http://bromley.example.org/admin/report_edit/4\nCouncil of the Thousand \(2\): http://www.example.org/admin/report_edit/2, http://www.example.org/admin/report_edit/1\nTfL \(1\): http://tfl.example.org/admin/report_edit/3.*report/$id2.*report/$id4.*report/$id3.*report/$id1%s, "includes count of reports and reports in fixed order"
    }
};
