...
subtest 'Scaffold form submission - smoke test' => sub {
  my $UPLOAD_DIR = tempdir( CLEANUP => 1 );
    FixMyStreet::override_config {
        ...
        $mech->current_form->find_input('terms_accepted', undef, 1)->value('Scaffold guidance notes and terms & conditions - March 2026');
        ...
        subtest 'sent emails' => sub {
            ...
            like $email_parts[6][0]{'Content-Disposition'}, qr{sample.pdf};
