...
subtest 'Mobile apparatus form submission - smoke test' => sub {
  my $UPLOAD_DIR = tempdir( CLEANUP => 1 );
    FixMyStreet::override_config {
        ...
        # Activity page
        $mech->submit_form_ok({ with_fields => {
            mobile_apparatus_activity => 'Building repair',
        }});
        ...
        $mech->submit_form_ok({ with_fields => {
            ...
            upload_traffic_management_plan => [ $sample_pdf, undef, Content_Type => 'application/pdf' ],
        }});
        ...
        for my $field (qw(upload_insurance upload_rams upload_traffic_management_plan upload_site_drawing)) {
