...
subtest 'Column attachments form submission - smoke test' => sub {
  my $UPLOAD_DIR = tempdir( CLEANUP => 1 );
    FixMyStreet::override_config {
        ...
        $mech->current_form->find_input('terms_accepted', undef, 1)->value('Column Attachments guidance notes and terms & conditions - March 2026');
        ...
        my $upload_dir = path($UPLOAD_DIR, "tfl-licence-column-attachments")->absolute(FixMyStreet->path_to());
