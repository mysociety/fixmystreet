...
subtest 'Skip form submission - smoke test' => sub {
  my $UPLOAD_DIR = tempdir( CLEANUP => 1 );
    FixMyStreet::override_config {
        ...
        $mech->get_ok('/licence/builders-skip');
        ...
        $mech->current_form->find_input('terms_accepted', undef, 1)->value('Builder’s skip guidance notes and terms & conditions - March 2026');
        ...
        my $problem = FixMyStreet::DB->resultset('Problem')
            ->search({ category => 'Builder’s skip licence' })
        ...
        like $detail, qr/\[Location of the skip\]/, 'Detail contains Location section header';
        ...
        for my $field (qw(upload_insurance upload_site_drawing upload_additional)) {
