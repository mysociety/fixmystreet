...
subtest 'Festive form submission - smoke test' => sub {
  my $UPLOAD_DIR = tempdir( CLEANUP => 1 );
    FixMyStreet::override_config {
        ...
        # Applicant page
        $mech->submit_form_ok({ with_fields => {
            organisation => 'Test Festive Ltd',
            job_title => 'Festive Decorator',
            name => 'Test Person',
        ...
        $mech->current_form->find_input('terms_accepted', undef, 1)->value('Festive Decorations guidance notes and terms & conditions - March 2026');
        ...
        like $detail, qr/\[Location of the festive decorations\]/, 'Detail contains Location section header';
        ...
        my $upload_dir = path($UPLOAD_DIR, "tfl-licence-festive")->absolute(FixMyStreet->path_to());
