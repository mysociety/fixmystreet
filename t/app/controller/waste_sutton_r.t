   ...
   subtest 'test report a problem - waste spillage' => sub {
    ...
    subtest 'Escalations of missed collections' => sub {
        ...
        subtest 'Open missed collection' => sub {
            ...
            $mech->content_like(qr/name="category" value="Escalate missed collection report" aria-describedby="category-item-hint"\s+disabled/s, 'Escalation option shown, but disabled, after end of window');
        };
