...
FixMyStreet::override_config {
    ...
    subtest 'Escalations of missed collections' => sub {
        ...
        subtest 'Open missed collection' => sub {
            ...
            $mech->get_ok('/waste/12345');
            $mech->content_lacks('Escalate a missed bulky collection');

            set_fixed_time('2025-04-10T19:00:00Z');
            $mech->get_ok('/waste/12345');
            $mech->follow_link_ok({ text => 'Escalate a missed bulky collection' });
            ...
            $mech->get_ok('/waste/12345');
            $mech->content_contains('Escalate a missed bulky collection');
