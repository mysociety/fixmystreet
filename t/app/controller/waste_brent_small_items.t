...
FixMyStreet::override_config {
    ...
    subtest 'Bulky goods email confirmation and reminders' => sub {
        ...
        subtest 'Email confirmation of booking' => sub {
            ...
            like $confirmation_email_txt, qr/- Small WEEE: Toaster/, 'Includes item 2';
            ...
            like $confirmation_email_txt, qr#http://brent.example.org/waste/12345/small_items_cancel#, 'Includes cancellation link';
            ...
            like $confirmation_email_html, qr/Small WEEE: Toaster/, 'Includes item 2 (html mail)';
            ...
            like $confirmation_email_html, qr#http://brent.example.org/waste/12345/small_items_cancel#, 'Includes cancellation link (html mail)';
