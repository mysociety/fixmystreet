...
subtest "check signature generation" => sub {
    ...
    is $sha, "2591DF29862B1A03529CEE4C8B4D6D6C1AF26E95FB3108BD76F60FBC915B55E2", "correct signature generated";
};
...
FixMyStreet::override_config {
    ...
    subtest 'check new sub credit card payment' => sub {
        ...
        ok !$mech->res->is_success(), "want a bad response";
        is $mech->res->code, 404, "got 404";
        $mech->get_ok("/waste/pay_complete/$report_id/$token?STATUS=9&ACCEPTANCE=54321");
