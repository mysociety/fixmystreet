...
FixMyStreet::override_config {
    ...
    subtest 'bank holiday message' => sub {
        ...
        $mech->content_lacks('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message not shown more than a week before');

        # 14 days before the bank holiday
        set_fixed_time('2024-03-18T02:00:00');
        $mech->get_ok('/waste/10001');
        $mech->content_contains('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message shown a week before');

        # Should still show the message on the day of the bank holiday
        set_fixed_time('2024-04-01T02:00:00');
        $mech->get_ok('/waste/10001');
        $mech->content_contains('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message shown on the day');

        # Should show the message for 1 week after the bank holiday
        set_fixed_time('2024-04-08T02:00:00');
        $mech->get_ok('/waste/10001');
        $mech->content_contains('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message shown one week after bank holiday');

        # Shouldn't show the message after 1 week
        set_fixed_time('2024-04-09T02:00:00');
        $mech->get_ok('/waste/10001');
        $mech->content_lacks('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message not shown more than one week after');
        ...
        $mech->content_contains('Due to the Bank Holiday, some of your bins that are scheduled to be', 'Bank holiday message shown with custom query parameter');
