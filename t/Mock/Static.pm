...
my $sample_rotated_file = path(__FILE__)->parent->parent->child("app/controller/sample-rotated-exif.jpg");
my $sample_rotated_photo = $sample_rotated_file->slurp_raw;
...
sub dispatch_request {
    ...
    sub (GET + /image-rotated.jpeg) {
        my ($self) = @_;
        return [ 200, [ 'Content-Type' => 'image/jpeg' ], [ $sample_rotated_photo ] ];
    },
}
